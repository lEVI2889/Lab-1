...
public class Task3 {
    ...
    public static String checkSimilar( Node building1, Node building2 ){
        ...
        if(c1==c2&&building1.elem.equals(building2.elem)){
            while(building1.next!=null&&building2.next!=null){
                if(building1.next.elem.equals(building2.next.elem)){
                    building1.next=building1.next.next;
                    building2.next=building2.next.next;
                }
                else{
                    return "Not Similar";
                }
